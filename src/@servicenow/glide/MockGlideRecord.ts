...
import { GlideRecordDBInit } from "../../common/GlideRecordDBInit.js";
import { SNTestEnvironment } from "../../common/SNTestEnvironment.js";
import { QueryEngine, QueryPlanStep } from "../../data/QueryEngine.js";
...
export class MockGlideRecord {
    ...
    private _queryPlan: readonly QueryPlanStep[] = [];
    ...
    isElementReferenceType(propName: string) {
    ...
    initQueryGr() {
        ...
        if (dbTable) {
            this.data = QueryEngine.execute(dbTable.getRows(), this._queryPlan);
            if (this.mockLimit) {
    ...
    public addActiveQuery(...args: any[]) {
        ...
        this._queryPlan = [...this._queryPlan, { type: "where", field: "active", operator: "=", value: true }];
    }
    ...
    public addNotNullQuery(name: string) {
        ...
        this._mockQuery.push(q);
        this._queryPlan = [...this._queryPlan, { type: "whereNotNull", field: name }];
    }
    ...
    public addNullQuery(fieldName: string) {
        ...
        this._queryPlan = [...this._queryPlan, { type: "whereNull", field: fieldName }];
        return condition;
    }
    ...
    public addQuery(name?: string, oper?: string, value?: any) {
        ...
        this._conditions.push(condition);
        const operator = value === undefined ? "=" : oper;
        const expected = value === undefined ? oper : value;
        this._queryPlan = [...this._queryPlan, { type: "where", field: name, operator: operator as any, value: expected }];
        return condition;
    }
    ...
    public setLimit(limit: number) {
        ...
        this._queryPlan = [...this._queryPlan.filter((step) => step.type !== "limit"), { type: "limit", value: limit }];
    }
    ...
    public setQueryPlan(plan: readonly QueryPlanStep[]) {
        this._queryPlan = [...plan];
    }
